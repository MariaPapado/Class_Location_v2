...
mask_dir = '/home/mariapap/CODE/CLv2_eval/PIPELINE_RESULTS/OUTPUT_comparegeojson/'
...
#    mask_img = cv2.imread(mask, cv2.IMREAD_UNCHANGED)
    ...
    xparams['id_before'] = mask_img.tags()['id_before']
    xparams['id_after'] = mask_img.tags()['id_after']

    xparams['ctime_before'] = mask_img.tags()['ctime_before']
    xparams['ctime_after'] = mask_img.tags()['ctime_after']
...
#    cv2.imwrite('/home/mariapap/CODE/CLv2_eval/PIPELINE_RESULTS/OUTPUT_reg/' + id, output_img)
    save_tif_coregistered_with_params('/home/mariapap/CODE/CLv2_eval/PIPELINE_RESULTS/OUTPUT_reg/' + id, output_img[:,:,[2,1,0]], xparams, bounds, channels=3)

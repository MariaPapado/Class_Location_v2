...
class Trainer(object):
    ...
    def validation(self):
        ...
        for itera, id in enumerate(tqdm(ids)):
            ...
            pre_change_imgs = Image.open(self.args.dataset_path + '{}'.format(id))
            ...
            cv2.imwrite('./NEW_PREDS_frp/before/{}.png'.format(id[:-4]), output_loc*255)
...
def main():
    ...
    parser.add_argument('--dataset_path', type=str, default='./TCimages/before/')
...
#    parser.add_argument('--test_data_list_path', type=str, default='/data/ggeoinfo/datasets/xBD/xBD_list/val_all.txt')
    ...
    parser.add_argument('--resume', type=str, default='/notebooks/MambaCD/changedetection/saved_models/xBD/MambaBDA_Small_1716407753.5717483/frp_8298_8255_8342_model.pth')
